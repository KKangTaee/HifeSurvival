...
namespace SimpleJSON
{
    ...
    public class JSONSourceData : JSONData
    {
        //public JSONSourceData(string aData)
        //    : base(aData)
        //{
        //}
        public JSONSourceData(float aData)
            : base(aData)
        {
        }
        public JSONSourceData(double aData)
            : base(aData)
        {
        }
        public JSONSourceData(bool aData)
            : base(aData)
        {
        }
        public JSONSourceData(int aData)
            : base(aData)
        {
        }
